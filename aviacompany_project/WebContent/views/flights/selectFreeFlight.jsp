...
<head>
<title><fmt:message
		key="views.flights.selectFreeFlight_jsp.title.Free_Flights" /></title>
<style>
body {
	...
	<div align="center">
		...
		<div>
			<button onclick="location.href='/aviacompany_project/my-account'">
				<fmt:message
					key="views.flights.selectFreeFlight_jsp.button.Back_to_main_page" />
			</button>
					...
					<tbody>
						...
						<%
							for (Flight flight : flights) {
									...
									out.println("<td><a href=\"/aviacompany_project/add-flight-to-order?id=" + flight.getIdFlight()
											+ "&orderStatus=" + orderStatus + "&idOrder=" + idOrder + "\">ADD TO ORDER</a></td>");
