...
<head>
<title><fmt:message
		key="views.persons.selectFreePerson_jsp.title.Free_Person" /></title>
<style>
body {
	...
	<div align="center">
		...
		<div>
			<button onclick="location.href='/aviacompany_project/my-account'">
				<fmt:message
					key="views.persons.selectFreePerson_jsp.button.Back_to_main_page" />
			</button>
			<button onclick="location.href='/aviacompany_project/add-person'">
				<fmt:message
					key="views.persons.selectFreePerson_jsp.button.Add_Person" />
			</button>
					...
					<tbody>
						...
						<%
							for (Person person : persons) {
									...
									out.println("<td><a href=\"/aviacompany_project/add-to-personal?id=" + person.getIdPerson()
											+ "&profession=" + profession + "&idPersonal=" + idPersonal
