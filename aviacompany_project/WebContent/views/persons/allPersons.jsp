...
<head>
<title><fmt:message
		key="views.persons.allPersons_jsp.title.All_Persons" /></title>
<style>
body {
	...
	<div align="center">
		...
		<div>
			<button onclick="location.href='/aviacompany_project/my-account'">
				<fmt:message
					key="views.persons.allPersons_jsp.button.Back_to_main_page" />
			</button>
			<%
				if (registeredUser != null && registeredUser.getRole().equals("admin")) {
			%>
			<button onclick="location.href='/aviacompany_project/add-person'">
				<fmt:message key="views.persons.allPersons_jsp.button.Add_Person" />
			</button>
			<%
				}
			%>
		...
		<div>
			...
			%>
			<button onclick="location.href='/aviacompany_project/add-person'">
				<fmt:message key="views.persons.allPersons_jsp.button.Add_PersonЫ" />
			</button>
			<%
				}
			%>
