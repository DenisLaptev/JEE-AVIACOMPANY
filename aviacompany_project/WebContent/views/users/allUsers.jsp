...
<body>
	...
	<div align="center">
		<h1>
			<fmt:message key="views.users.allUsers_jsp.h1.All_All_Users_Table" />
		</h1>
		...
		<div>
			<button
				onclick="location.href='<%=request.getContextPath()%>/my-account'">
				<fmt:message key="views.users.allUsers_jsp.button.Back_to_main_page" />
			</button>
			<%
					...
					<tbody>
						...
						<%
							if (registeredUser != null && registeredUser.getRole().equals("admin")) {
									for (User user : users) {
										out.println("<tr>");
										out.println("<td><a href=\"/aviacompany_project/user-by-id?id=" + user.getIdUser() + "\">"
												+ user.getIdUser() + "</a></td>");
										...
										out.println("<td><a href=\"/aviacompany_project/update-user-by-id?id=" + user.getIdUser()
												+ "\">Update</a></td>");
										out.println("<td><a href=\"/aviacompany_project/delete-user-by-id?id=" + user.getIdUser()
												+ "\">Delete</a></td>");
										out.println("</tr>");
									}
								} else {
