...
<head>
<title><fmt:message
		key="views.users.updateUser_jsp.title.Update_user" /></title>
<style>
body {
...
<body>
	...
	<div align="center" style="padding-top: 20%">
		<h1>
			<fmt:message key="views.users.updateUser_jsp.h1.Updating_User" />
		</h1>
		...
		<button onclick="location.href='<%=request.getContextPath()%>/users'">
			<fmt:message key="views.users.updateUser_jsp.button.All_Users_Table" />
		</button>
	</div>
</body>
</html>
