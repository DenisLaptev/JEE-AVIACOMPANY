...
<head>
<title><fmt:message
		key="views.personals.addPersonal_jsp.title.Add_new_personal" /></title>
<style>
body {
...
<body>
	...
	<div align="center" style="padding-top: 20%">
		<h1>
			<fmt:message
				key="views.personals.addPersonal_jsp.h1.Adding_New_Personal" />
		</h1>
				...
				<table>
					<tr>
						...
						<td>
							<%
								out.println(
										"<button onclick=\"location.href='/aviacompany_project/free-person?profession=Pilot1&idPersonal="
					...
					<tr>
						...
						<td>
							<%
								out.println(
										"<button onclick=\"location.href='/aviacompany_project/free-person?profession=Pilot2&idPersonal="
												+ idPersonal + "'\">Add</button>");
							%>
						</td>
					</tr>
					<tr>
						...
						<td>
							<%
								out.println(
										"<button onclick=\"location.href='/aviacompany_project/free-person?profession=Shturman&idPersonal="
												+ idPersonal + "'\">Add</button>");
							%>
						</td>
					</tr>
					<tr>
						...
						<td>
							<%
								out.println(
										"<button onclick=\"location.href='/aviacompany_project/free-person?profession=Radist&idPersonal="
												+ idPersonal + "'\">Add</button>");
							%>
						</td>
					</tr>
					<tr>
						...
						<td>
							<%
								out.println(
										"<button onclick=\"location.href='/aviacompany_project/free-person?profession=Stuardes1&idPersonal="
												+ idPersonal + "'\">Add</button>");
							%>
						</td>
					</tr>
					<tr>
						...
						<td>
							<%
								out.println(
										"<button onclick=\"location.href='/aviacompany_project/free-person?profession=Stuardes2&idPersonal="
												+ idPersonal + "'\">Add</button>");
							%>
						</td>
					</tr>
					<tr>
						...
						<td>
							<%
								out.println(
										"<button onclick=\"location.href='/aviacompany_project/free-person?profession=Stuardes3&idPersonal="
												+ idPersonal + "'\">Add</button>");
							%>
						</td>
					</tr>
		...
		<button onclick="location.href='/aviacompany_project/personals'">
			<fmt:message
				key="views.personals.addPersonal_jsp.button.All_Personals_Table" />
		</button>
	</div>
</body>
</html>